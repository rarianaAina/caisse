...
export function BusinessProfilePanel({ db }: { db: SqlExecutor }) {
  ...
  return (
    <section className="carte p-6">
      <h2 className="text-base font-semibold text-ardoise-900">Type de commerce</h2>
      ...
      {profile === 'restaurant' && (
        <div className="mt-5 border-t border-ardoise-200 pt-4">
          <h3 className="text-base font-semibold text-ardoise-900">Imprimante de la cuisine</h3>
